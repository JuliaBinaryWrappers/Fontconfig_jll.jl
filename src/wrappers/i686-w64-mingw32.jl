...
export fc_conflist, fonts_conf, fc_cache, fc_query, fc_scan, libfontconfig, fc_list, fc_match, fc_pattern, fc_cat, fc_validate
...
const fc_conflist_splitpath = ["bin", "fc-conflist.exe"]
...
const fc_cache_splitpath = ["bin", "fc-cache.exe"]
...
const fc_query_splitpath = ["bin", "fc-query.exe"]
...
const fc_scan_splitpath = ["bin", "fc-scan.exe"]
...
const libfontconfig_splitpath = ["bin", "libfontconfig-1.dll"]
...
const libfontconfig = "libfontconfig-1.dll"


# Relative path to `fc_list`
const fc_list_splitpath = ["bin", "fc-list.exe"]
...
const fc_match_splitpath = ["bin", "fc-match.exe"]
...
const fc_pattern_splitpath = ["bin", "fc-pattern.exe"]
...
const fc_cat_splitpath = ["bin", "fc-cat.exe"]
...
const fc_validate_splitpath = ["bin", "fc-validate.exe"]
